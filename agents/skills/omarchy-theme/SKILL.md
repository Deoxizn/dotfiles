...
Current as of 2026-09: **Omarchy 4.0 "Quattro"** is stable (Aug 2026). Themes now carry
an expanded **24-color set** (up from 8) so terminal, btop, Neovim, and VS Code configs
can be autogenerated from the palette; a machine-level `~/.config/omarchy/shell.toml`
override (font, spacing, bar tweaks) merges over the active theme and survives theme
switching; recent additions include the Solitude, Last Horizon, and Lupine themes.

## 0. Reference Documentation & Resources
- **Quickshell Documentation**: [https://quickshell.org/docs/](https://quickshell.org/docs/) — Reference for QML styling properties, color bindings, and dynamic property resolution[cite: 1].
- **Quickshell GitHub Repository**: [https://github.com/outfoxxed/quickshell](https://github.com/outfoxxed/quickshell) — Reference for low-level architecture and styling integration[cite: 1].
